...
from models.losser import LabelSmoothingCriterion, BOWLossCriterion, EMBLossCriterion, MultiGPULossCompute, \
    DistanceLabelSmoothingCriterion, DistanceAutoMLCriterion, DistanceAutoMLSmallMatrixCriterion, \
...
def main():
    ...
    if wargs.pre_train is not None:
        ...
        for name, param in nmtModel.named_parameters():
            if name in model_dict:
                ...
                init_params(param, name, init_D=wargs.param_init_D, a=float(wargs.u_gain))
    ...
    trainer = Trainer(nmtModel_par, batch_train, vocabs, optim, lossCompute, nmtModel, batch_valid, batch_tests, writer)
